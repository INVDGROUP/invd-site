...
function SectionEyebrow({
  ...
  return (
    ...
    >
      ...
      <span
        className={`text-[10px] font-semibold uppercase tracking-[0.34em] ${color}`}
      >
        {children}
      </span>
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#002B3A] text-white selection:bg-[#0997F7] selection:text-white">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#001F2C]/88 backdrop-blur-xl">
        <div className="mx-auto grid h-[74px] max-w-7xl grid-cols-[150px_1fr_auto] items-center gap-6 px-6 lg:px-10">
          ...
          <nav className="hidden items-center justify-center gap-9 text-[11px] font-semibold text-white/62 md:flex">
          ...
          <a
            ...
            className="rounded-lg border border-[#0997F7]/50 bg-[#0997F7] px-5 py-3 text-[11px] font-black uppercase tracking-[0.08em] text-white shadow-[0_0_24px_rgba(9,151,247,0.25)] transition hover:-translate-y-0.5 hover:bg-[#0478C7] hover:shadow-[0_0_34px_rgba(9,151,247,0.38)]"
          >
            Fale com a INVD
          </a>
        </div>
      ...
      <section className="relative overflow-hidden bg-[#001F2C]">
        ...
        <div className="relative mx-auto grid min-h-[790px] max-w-7xl items-center gap-14 px-6 pb-28 pt-36 lg:grid-cols-[minmax(0,1fr)_390px] lg:px-10 lg:pb-36 lg:pt-44">
          <div className="max-w-[720px]">
            ...
            <h1 className="font-impact reveal text-[4rem] font-black leading-[0.94] tracking-[-0.045em] text-white sm:text-[5.2rem] md:text-[6.4rem] lg:text-[7.1rem]">
              Estratégia que
              <span className="block">posiciona e</span>
              <span className="relative inline-block text-[#0997F7]">
                acelera
            ...
            <div className="reveal reveal-delay-2 mt-11 flex flex-col gap-4 sm:flex-row">
              ...
              <a
                href="#metodo"
                className="inline-flex items-center justify-center rounded-lg border border-white/14 bg-white/[0.02] px-7 py-4 text-xs font-bold text-white/78 transition hover:-translate-y-0.5 hover:border-[#0997F7]/55 hover:bg-white/[0.04] hover:text-white"
              >
                Como trabalhamos
              </a>
            </div>
          ...
          <div className="panel-glow reveal reveal-delay-2 relative rounded-2xl border border-[#0997F7]/24 bg-[#062F3E]/70 p-6 backdrop-blur-xl">
            ...
            <div className="grid gap-5">
              {heroMetrics.map((metric) => (
                <div
                  key={metric.label}
                  className="group grid grid-cols-[44px_1fr] items-center gap-5 rounded-xl border border-white/10 bg-[#042A38]/72 p-5 transition hover:border-[#0997F7]/45 hover:bg-[#073747]"
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-lg border border-[#0997F7]/25 bg-[#0997F7]/10 text-[#0997F7] transition group-hover:shadow-[0_0_24px_rgba(9,151,247,0.18)]">
                    {metric.icon}
                  </div>

                  <div>
                    <span className="font-impact block text-[2.65rem] leading-none tracking-[-0.03em] text-white">
                      {metric.value}
                    </span>
                    <span className="mt-2 block text-[10px] font-semibold uppercase tracking-[0.22em] text-white/42">
                      {metric.label}
                    </span>
                  </div>
                </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-14 px-6 py-24 lg:grid-cols-[1.02fr_0.98fr] lg:px-10">
          <div>
            ...
            <h2 className="font-impact max-w-xl text-4xl font-black leading-[1.08] tracking-normal md:text-5xl">
              ...
              <span className="blue-marker">estratégico</span> para empresas
              que querem crescer de verdade
              <span className="text-[#C0005A]">.</span>
            </h2>

            <p className="mt-6 max-w-xl text-sm leading-7 text-[#071F2A]/72 md:text-base">
              A INVD é uma agência de marketing em Brasília para empresas que
              faturam mas travam no crescimento. Atuamos com reposicionamento de
              marca, reestruturação de marketing e escala de resultados — sempre
              com visão comercial e performance mensurável.
            </p>

            <p className="mt-5 max-w-xl text-sm leading-7 text-[#071F2A]/58 md:text-base">
              Não somos fornecedor. Somos parceiros estratégicos que atuam
              próximos à decisão, reestruturando o que você comunica, vende e
              escala no mercado.
            </p>
          </div>
      ...
      <section id="servicos" className="relative overflow-hidden bg-[#002B3A]">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="relative mx-auto max-w-2xl text-center">
            <SectionEyebrow align="center" tone="light">
              O que fazemos
            </SectionEyebrow>
      ...
      <section
        id="metodo"
        className="relative overflow-hidden bg-[#002B3A] text-white"
      >
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="max-w-3xl">
            ...
            <h2 className="font-impact text-4xl font-black leading-[1.08] tracking-normal md:text-6xl">
              ...
              <span className="blue-marker mt-2 block w-fit">
                INVD<span className="text-[#C0005A]">.</span>
              </span>
            </h2>

            <p className="mt-6 max-w-2xl text-sm leading-7 text-white/70 md:text-base">
              Empresas que faturam mas não escalam geralmente têm um problema de
              estratégia, não de execução. Por isso começamos pelo diagnóstico.
            </p>
          </div>
          ...
          <div className="relative mt-14 grid gap-5 md:grid-cols-[1.4fr_1fr] lg:grid-cols-[1.5fr_1fr]">
            {cases
              ...
              .map((item) => (
                ...
                >
                  <svg
                    className="absolute bottom-8 right-8 h-28 w-56 text-[#0997F7]/18 transition group-hover:text-[#0997F7]/26"
                    viewBox="0 0 240 112"
                    fill="none"
                    aria-hidden="true"
                  >
                    <path
                      d="M4 86 C38 78 45 42 78 54 C112 66 110 20 145 26 C180 31 178 74 210 52 C222 44 229 35 236 28"
                      stroke="currentColor"
                      strokeWidth="3"
                      strokeLinecap="round"
                    />
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-xs font-bold uppercase tracking-[0.16em] text-[#0997F7]/78">
                      {item.service}
                    </p>
                  ...
                  <div className="relative mt-8 border-t border-white/10 pt-7">
                    <span className="font-impact block text-6xl leading-none text-white">
                      {item.metric}
                    </span>
                    <span className="mt-2 block max-w-sm text-sm leading-6 text-white/48">
                      {item.metricLabel}
                    </span>
                  </div>
                </a>
                ...
                .map((item) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-2 text-[10px] font-bold uppercase tracking-[0.15em] text-[#0997F7]/74">
                        {item.service}
                      </p>
                    </div>
                    <div className="mt-6 flex items-end justify-between border-t border-white/10 pt-5">
                      ...
                      <span className="text-white/20 transition group-hover:text-[#0997F7]">
                        <ArrowIcon />
                      </span>
                    </div>
                  </a>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="mb-12 max-w-2xl">
            ...
            <h2 className="font-impact text-4xl font-black leading-[1.08] tracking-normal md:text-5xl">
              ...
              <br />
              escolhem a
              <span className="blue-marker"> INVD</span>
              <span className="text-[#C0005A]">.</span>
            </h2>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {differentials.map((item) => (
              ...
              >
                ...
                <h3 className="text-base font-black text-[#071F2A]">
                  {item.title}
                </h3>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="panel-glow relative mx-auto max-w-4xl rounded-3xl border border-[#0997F7]/18 bg-white/[0.045] px-6 py-14 text-center backdrop-blur md:px-12">
            ...
            <p className="mx-auto mt-6 max-w-xl text-sm leading-7 text-white/68 md:text-base">
              Converse com nosso time e descubra como a INVD pode reposicionar
              sua marca, reestruturar seu marketing e escalar seus resultados
              com estratégia e performance.
            </p>
      ...
      <footer className="border-t border-white/10 bg-[#002B3A]">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10">
          ...
          <div className="mt-12 flex flex-col gap-4 border-t border-white/5 pt-6 text-xs text-white/30 md:flex-row md:items-center md:justify-between">
            <p>
              © 2026 INVD — Agência de Marketing em Brasília · Todos os direitos
              reservados.
            </p>
            <button
