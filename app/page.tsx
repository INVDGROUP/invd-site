  ...
  return (
    <main className="min-h-screen bg-[#002B3A] text-white selection:bg-[#0997F7] selection:text-white">
      ...
      <section className="relative overflow-hidden bg-[#002B3A]">
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,43,58,0.18)_0%,rgba(0,43,58,0.96)_100%)]" />
        <div className="absolute inset-x-0 bottom-0 h-4 bg-[#0997F7]" />
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-28 lg:px-10 lg:pb-28 lg:pt-32 grid lg:grid-cols-[1fr_auto] gap-16 items-center">
          <div className="max-w-3xl">
            ...
            <h1 className="font-impact reveal text-5xl font-black leading-[0.95] tracking-normal text-white md:text-7xl lg:text-[5.8rem]">
              Estratégia que
              <span className="mt-3 block w-fit bg-[#0997F7] px-4 py-2 text-white">
                posiciona e
              </span>
              <span className="block w-fit bg-[#0997F7] px-4 pb-2 text-white">
                acelera.
              </span>
            </h1>
            ...
            <div className="reveal reveal-delay-2 mt-10 flex flex-col gap-4 sm:flex-row">
              <a
                ...
                className="inline-flex items-center justify-center rounded-md bg-[#0997F7] px-7 py-4 text-sm font-black uppercase text-white transition hover:bg-[#0478C7]"
              >
              ...
              <a
                href="#metodo"
                className="inline-flex items-center justify-center rounded-md border border-white/15 px-7 py-4 text-sm font-semibold text-white/80 transition hover:border-white/30 hover:text-white"
              >
                Como trabalhamos
              </a>
            </div>
          ...
          <div className="hidden lg:flex flex-col justify-center gap-6">
            <div className="reveal reveal-delay-1 border-l-2 border-[#0997F7] pl-6">
              <span className="block text-4xl font-black text-white tracking-normal">+150k</span>
              <span className="block text-[11px] uppercase tracking-[0.25em] text-white/40 mt-1">Leads gerados</span>
            </div>
            <div className="h-px w-full bg-white/5" />
            <div className="reveal reveal-delay-2 border-l-2 border-[#0997F7] pl-6">
              <span className="block text-4xl font-black text-white tracking-normal">+R$7Mi</span>
              <span className="block text-[11px] uppercase tracking-[0.25em] text-white/40 mt-1">Em receita para clientes</span>
            </div>
            <div className="h-px w-full bg-white/5" />
            <div className="reveal reveal-delay-3 border-l-2 border-[#0997F7] pl-6">
              <span className="block text-4xl font-black text-white tracking-normal">5 anos</span>
              <span className="block text-[11px] uppercase tracking-[0.25em] text-white/40 mt-1">De mercado</span>
            </div>
          </div>
        </div>

        <div className="h-8 bg-[#0997F7]" />
      </section>
      ...
      <section id="sobre" className="paper-bg text-[#071F2A]">
        <div className="mx-auto grid max-w-7xl gap-14 px-6 py-24 lg:grid-cols-[1.05fr_0.95fr] lg:px-10">
          <div>
            ...
            <h2 className="font-impact max-w-xl text-4xl font-black leading-[1] tracking-normal md:text-5xl">
              Agência de marketing estratégico para empresas que querem crescer de verdade<span className="text-[#0997F7]">.</span>
            </h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {pillars.map((item) => (
              <div
                key={item.title}
                className="relative rounded-md border-l-4 border-[#0997F7] bg-white/85 p-6 shadow-[0_10px_30px_rgba(0,43,58,0.08)]"
              >
                <span className="absolute right-4 top-3 text-4xl font-black text-[#B9E2FF]">
                  {item.letter}
                </span>
      ...
      <section id="servicos" className="bg-[#002B3A]">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="font-impact text-4xl font-black leading-[1] tracking-normal md:text-5xl">
          ...
          <div className="mt-14 flex flex-col gap-4">
            {services.map((service, index) => (
              <div
                key={service.title}
                className="reveal group flex items-center gap-8 rounded-md border-l-4 border-white/20 bg-white/[0.03] px-8 py-6 transition hover:border-[#0997F7] hover:bg-white/[0.06]"
              >
                <span className="text-5xl font-black text-white/10 group-hover:text-[#0997F7]/30 transition w-16 shrink-0 tracking-normal">
                  {String(index + 1).padStart(2, "0")}
                </span>
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-md bg-[#042B3A]">
                  {service.icon}
                </div>
                ...
                <span className="text-white/20 group-hover:text-[#0997F7] transition text-xl shrink-0">→</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="metodo" className="bg-[#002B3A] text-white">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="max-w-3xl">
            <div className="mb-6 flex items-center gap-3">
              <span className="h-px w-10 bg-[#0997F7]" />
            ...
            <h2 className="font-impact text-4xl font-black leading-[1] tracking-normal md:text-6xl">
              Como funciona o método
              <span className="mt-5 block w-fit bg-[#0997F7] px-4 py-2 text-white">
                INVD
              </span>
            </h2>
          ...
          <div className="mt-16 grid gap-x-16 gap-y-14 md:grid-cols-2">
            {[
              ...
              <div key={item.step} className="border-l-4 border-white/35 pl-7">
                <span className="font-impact text-6xl leading-none text-[#0997F7]">
                  {item.step}
                </span>
                <h3 className="font-impact mt-3 text-3xl font-black text-[#0997F7]">
                  {item.title}
                </h3>
                <p className="mt-2 text-xl leading-8 text-white">{item.text}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-14 text-center">
            <a
              ...
              className="inline-flex items-center justify-center rounded-md bg-[#0997F7] px-8 py-4 text-sm font-black uppercase text-white transition hover:bg-[#0478C7]"
            >
      ...
      <section id="cases" className="bg-[#002B3A]">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="mx-auto max-w-2xl text-center">
            <div className="mb-6 flex items-center justify-center gap-3">
              <span className="h-px w-10 bg-[#0997F7]" />
            ...
            <h2 className="font-impact text-4xl font-black leading-[1] tracking-normal md:text-5xl">
              ...
              <br />
               e resultados reais
              <span className="text-[#0997F7]">.</span>
            </h2>
          </div>
          ...
          <div className="mt-14 grid gap-4 md:grid-cols-[1.4fr_1fr] lg:grid-cols-[1.5fr_1fr]">
            {cases.filter(c => c.featured).map(item => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="reveal group relative rounded-md border border-white/8 bg-white/[0.02] p-8 transition hover:border-[#0997F7]/50 flex flex-col justify-between row-span-2"
              >
                <div>
                  ...
                  <p className="mt-1 text-xs uppercase tracking-[0.15em] text-[#0997F7]/70">{item.service}</p>
                  <p className="mt-5 text-sm leading-7 text-white/50">{item.text}</p>
                </div>
                <div className="mt-8 border-t border-white/8 pt-6">
                  <span className="block text-5xl font-black text-white tracking-normal">{item.metric}</span>
            ...
            <div className="flex flex-col gap-4">
              {cases.filter(c => !c.featured).map(item => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="reveal group rounded-md border border-white/8 bg-white/[0.02] p-7 transition hover:border-[#0997F7]/50 flex flex-col justify-between"
                >
                  <div>
                    <span className="text-[10px] uppercase tracking-[0.25em] text-white/35">{item.subtitle}</span>
                    <h3 className="mt-2 text-lg font-bold text-white">{item.title}</h3>
                    <p className="mt-1 text-[10px] uppercase tracking-[0.15em] text-[#0997F7]/70">{item.service}</p>
                  </div>
                  <div className="mt-5 border-t border-white/8 pt-4 flex items-end justify-between">
                    <div>
                      <span className="block text-3xl font-black text-white tracking-normal">{item.metric}</span>
                      <span className="block text-xs text-white/40 mt-1">{item.metricLabel}</span>
                    </div>
                    <span className="text-white/20 group-hover:text-[#0997F7] transition text-xl">→</span>
                  </div>
                </a>
              ))}
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="mb-12 max-w-2xl">
            ...
            <h2 className="font-impact text-4xl font-black leading-[1] tracking-normal md:text-5xl">
              ...
              <br />
              escolhem a
              <span className="text-[#0997F7]"> INVD</span>
            </h2>
          </div>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {differentials.map((item) => (
              <div
                key={item.title}
                className="reveal rounded-md border border-[#D8E1E8] bg-white p-6 shadow-[0_10px_30px_rgba(0,0,0,0.03)]"
              >
                <h3 className="text-sm font-bold text-black">{item.title}</h3>
                <p className="mt-3 text-sm leading-6 text-black/55">
                  {item.text}
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <a
              ...
              className="mt-10 inline-flex items-center justify-center rounded-md bg-[#0997F7] px-8 py-4 text-sm font-black uppercase text-white transition hover:bg-[#0478C7]"
            >
              Quero escalar com a INVD
              <span className="ml-2">→</span>
            </a>
            ...
            <div>
              ...
              <div className="mt-5">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center rounded-md border border-white/10 px-4 py-2 text-sm text-white/75 transition hover:border-[#0997F7] hover:text-white"
                >
                  WhatsApp
                </a>
              </div>
